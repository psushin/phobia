...
#define EXT_IN1        3            // Внешний сигнал активации 1 (от первой платы кристалла)
...
/*
  ...
  attachInterrupt(1, cristall2_enable, FALLING); 
...
void loop() {
  ...
  {
    if(cristall2_mode_on) sd_access_yellow;
    ...
    { 
...
#endif
      sd_access_green;      
	  if(cristall2_mode_on)
	   {
		 
		 if(!SENDED_OK) Serial.print("Cristall_OK");  
		 SENDED_OK = 1;
	     delay(2000);
	   }
	  if(cristall2_mode_on) sd_access_yellow;
     ...
     { //если карточка не верна
       ...
       sd_access_red;
       delay(2000);
       if(!cristall2_mode_on) sd_access_clear;
	   else sd_access_yellow;
       //delay(118000); 
     }
